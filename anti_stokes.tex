...
the determination of the particle temperature. }
...
called anti-Stokes emission\cite{Jiang2013,He2015,Carattino2016a}\HI{\cite{xie2016thermometry}}.

\HI{Here we present a simple model and experimental results to show that the absolute 
temperature of optically excited gold nanorods can be determined by measuring the blue-shifted 
photoluminescence emission spectra with an accuracy of $6$\%. 
Moreover, we can measure the temperature of the medium surrounding the nanorods with an accuracy of $2$\%.}
...
\HI{When we resonatly excite with mocromatic light a gold nanorod with 
resonance frequency  $\omega_\textrm{L}$ a collective oscillation of the gas of conduction
...
energy\cite{Sundararaman2014,Brongersma2015,AlejandroManjavacasJunG.LiuVikramKulkarni2014}, i.e. 
