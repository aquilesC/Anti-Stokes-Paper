...
electron-hole pairs created by the decay of the plasmonn, after their interaction
...
%that will be obtain by exciting the particle at energy much higher than the resonance. 
...
%\ref{fig:AS_in_Log} shows the results of this procedure. 
...
%$\textrm{I}_\textrm{SPR}(\omega)$ from equation \ref{eqn:fitting} and also 
...
%the calculated temperatures for a particle with plasmon overlapping the measured one
...
%temperature at zero excitation power for each case as was explained earlier. 
%\HI{The obtained values} are shown in the inset of the figure, \HI{where the red line
%with slope $1$ is a guide to the eye and the dashed line is a fit to the data with unity 
%slope. We found a systematic offset in our measurements of $3.8$ \K with represents a
