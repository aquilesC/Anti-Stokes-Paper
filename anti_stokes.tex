...
%temperature with high accuracy. An alternative could be the use of dyes, show a very low amount of
%emitted photons with a higher energy than the excitation energy, rendering their
%use in biological conditions very challenging. 
...
%Many cellular processes may be subject to
%temperature variations, including heat generation at mitochondria. 
%Experimental access to these temperature changes is a challenging taskat a cellular and sub-celullar level has
%Temperature changes due to cellular process has been subject to extensive
%debate\cite{Yang2011a,Suzuki2015}.  However the
...
optical photon. 
Finally, only the presence of hot carriers is required in the
model.
One important assumption for this model is that the coupling 
...
%Differences in the distribution of electrons and
...
%longer\cite{Yorulmaz2012}. 
The only remaining free parameter is the temperature $T$ (plus a
...
up to $60\,^o$C and to monitor it through a Pt100 resistance thermometer placed
$1\mm$ away from the observation area. More details about the experimental
setup are given in the supplementary information.


%Nanorods were synthesized following the seeded-growth method\cite{Nikoobakht2003}. 
...
The intensity of the lasers was controlled via the voltage applied to an acousto-optic modulator in
...
ranging from $25\uW$ to $75\uW$ at the back aperture of the objective.  %%%%%%%%%%%%%%%%% should change to intensity or clearly mention the spot size
