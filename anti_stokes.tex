...
of the temperature of the medium with 6 spectral measurements of $180\sec$ integration time.}
...
\HI{upon resonant CW-mild irradiation. The error is less than $10\K$ with an acquisition time of $180\sec$; with a set of such measurements, the temperature of the surrounding medium can be determined with $4\K$ accuracy or better.}
...
\begin{enumerate}
	...
	exciting with a $532\nm$ laser. 
	\item We fit the emission with a Lorentizan line shape to get the term $I_\textrm{SPR}(\omega)$ appearing in equation \ref{eqn:fitting}.
	\item Excite near the longitudinal plasmonic resonance and detect the blue-shifted anti-Stokes emission. For this we employed a $633\nm$  laser. 
...
This is done in an approximate way using the function $I_\textrm{SPR}(\omega)$ calculated in point 2 of the protocol.}
...
modeling of the photoluminescence. The first step in the fitting procedure is the determination
