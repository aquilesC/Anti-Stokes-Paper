...
The width obtained from the images is $(25 \pm 5)$ nm while the mean length is $(50 \pm 6)$ nm, leading to a mean aspect ratio of $(2.03 \pm 0.4)$. 
...
(b) Bulk absorbance spectra of the gold nanorod sample showing the transverse (around $525$ nm) and the longitudinal surface plasmon resonances. The dashed vertical lines show the two laser wavelengths used in this work.}
	\label{fg:nr-char}
\end{figure}
