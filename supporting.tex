...
size similar to the ones presented in the main text, i.e. a %bulk 
SPR around $630$ nm. 
...
photons s$^{-1}$ $\upmu$m$^{-2}$, which leads to a fluence of %$\approx 2.46\times10^{17}$ photons $\mu$m$^{-2}$ 
...
The mean width %\footnote{We report here the mean $\pm$ standard deviation of the population.} 
