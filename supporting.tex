...
The phenomenological model we use to extract the temperature from the anti-Stokes spectrum depends on the prior determination of the plasmon resonance. In our case, we measure the photoluminescence emission spectrum 
...
phenomenologically modeled as $B(E;\Delta) = \exp(E/\Delta)$, and $I_\textrm{SPR}(E)$ surface 
plasmon resonance spectra (SPR) and $A_1$ and $A_2$ are constants. 
...
\caption{\testbf{Stokes and anti-Stokes integrated emission as a function of excitation power.} The
